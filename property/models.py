...
class Flat(models.Model):
    ...
    liked_by = models.ManyToManyField(User, verbose_name='Кто лайкнул', related_name="liked_posts", null=True, blank=True)
...
class Owner(models.Model):
    ...
    property_flats = models.ManyToManyField(Flat, verbose_name='Квартиры в собственности', related_name='flats_owner')
